...
if("TRUE" STREQUAL "TRUE")
  set(rotors_gazebo_plugins_SOURCE_PREFIX /home/vgampa/mpc_quad/src/CrazyS/rotors_gazebo_plugins)
  set(rotors_gazebo_plugins_DEVEL_PREFIX /home/vgampa/mpc_quad/devel/.private/rotors_gazebo_plugins)
  ...
  set(rotors_gazebo_plugins_INSTALL_PREFIX /home/vgampa/mpc_quad/install)
...
if(NOT "/home/vgampa/mpc_quad/src/CrazyS/rotors_gazebo_plugins/include;/usr/include/eigen3;/usr/include/opencv4 " STREQUAL " ")
  set(rotors_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/vgampa/mpc_quad/src/CrazyS/rotors_gazebo_plugins/include;/usr/include/eigen3;/usr/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vgampa/mpc_quad/src/CrazyS/rotors_gazebo_plugins/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/vgampa/mpc_quad/devel/.private/rotors_gazebo_plugins/lib;/home/vgampa/mpc_quad/devel/lib;/opt/ros/noetic/lib)
